<?php
  ...
  if (isset($_POST['userCode'])) {
    ...
    if ($query->rowCount()) {
      ...
      sqlUpdate('puyoServer', "user1_batankyu=$batankyu,user1_puyosCount=$puyosCount,user1_board='$myBoard'", "id={$data['id']}");
    } else {
      ...
      if ($query->rowCount()) {
        ...
        sqlUpdate('puyoServer', "user2_batankyu=$batankyu,user2_puyosCount=$puyosCount,user2_board='$myBoard'", "id={$data['id']}");
      }
    }
  }
